...
func (r *Room) TryJoin(p player.Player) (success bool) {
	...
	if r.p1 == nil {
		...
		logger.Infof("Player with UID %d is now p1 in room_manager", p.UID())
		err := r.notifyP1(message.Message{Title: "CONNECTED", Payload: "you've been added to room_manager"})
		if err != nil {
