...
func TestRegisterHandlerUnsuccessfulWrongForms(t *testing.T) {
	...
	cases := []TestCaseReg{
		...
		TestCaseReg{
			...
			password1: "12938109238Hsdskdjhfksdhfkj",
			password2: "12938109238Hsdskdjhfksdhfkj",
			error:     `{"nickname":"Никнейм не может быть короче 3 символов"}`,
		},
		TestCaseReg{
			number:    8,
		...
		TestCaseReg{
			...
			password1: "",
			password2: "1",
			error:     `{"email":"Неверно введён адрес электронной почты","password":"Пароль слишком короткий","password2":"Пароли не совпадают","nickname":"Никнейм не может быть короче 3 символов"}`,
		},
		TestCaseReg{
			number:    10,
			email:     "",
			...
			password1: "12129J",
			password2: "120912129J",
			error:     `{"email":"Неверно введён адрес электронной почты","password":"Пароль слишком короткий","password2":"Пароли не совпадают","nickname":"Никнейм не может быть длиннее 16 символов"}`,
		},
	}
