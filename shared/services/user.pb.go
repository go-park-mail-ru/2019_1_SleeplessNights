...
type MatchResults struct {
	...
	WinnerRating         uint64   `protobuf:"varint,3,opt,name=winnerRating,proto3" json:"winnerRating,omitempty"`
	LoserRating          uint64   `protobuf:"varint,4,opt,name=loserRating,proto3" json:"loserRating,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *MatchResults) Reset()         { *m = MatchResults{} }
func (m *MatchResults) String() string { return proto.CompactTextString(m) }
func (*MatchResults) ProtoMessage()    {}
func (*MatchResults) Descriptor() ([]byte, []int) {
	return fileDescriptor_116e343673f7ffaf, []int{9}
}

func (m *MatchResults) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_MatchResults.Unmarshal(m, b)
}
func (m *MatchResults) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_MatchResults.Marshal(b, m, deterministic)
}
func (m *MatchResults) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MatchResults.Merge(m, src)
}
func (m *MatchResults) XXX_Size() int {
	return xxx_messageInfo_MatchResults.Size(m)
}
func (m *MatchResults) XXX_DiscardUnknown() {
	xxx_messageInfo_MatchResults.DiscardUnknown(m)
}

var xxx_messageInfo_MatchResults proto.InternalMessageInfo

func (m *MatchResults) GetWinner() uint64 {
	if m != nil {
		return m.Winner
	}
	return 0
...
func (m *MatchResults) GetLoser() uint64 {
	if m != nil {
		return m.Loser
	}
	return 0
...
func (m *MatchResults) GetWinnerRating() uint64 {
	if m != nil {
		return m.WinnerRating
	}
	return 0
}

func (m *MatchResults) GetLoserRating() uint64 {
	if m != nil {
		return m.LoserRating
	}
	return 0
}
...
func init() {
	...
	proto.RegisterType((*MatchResults)(nil), "services.MatchResults")
...
var fileDescriptor_116e343673f7ffaf = []byte{
	...
	,
}
...
type UserMSClient interface {
	...
	UpdateStats(ctx context.Context, in *MatchResults, opts ...grpc.CallOption) (*Nothing, error)
}
...
func (c *userMSClient) UpdateStats(ctx context.Context, in *MatchResults, opts ...grpc.CallOption) (*Nothing, error) {
	out := new(Nothing)
	err := c.cc.Invoke(ctx, "/services.UserMS/UpdateStats", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserMSServer interface {
	...
	UpdateStats(context.Context, *MatchResults) (*Nothing, error)
}
...
func (*UnimplementedUserMSServer) UpdateStats(ctx context.Context, req *MatchResults) (*Nothing, error) {
...
func _UserMS_UpdateStats_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MatchResults)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserMSServer).UpdateStats(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/services.UserMS/UpdateStats",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserMSServer).UpdateStats(ctx, req.(*MatchResults))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _UserMS_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _UserMS_UpdateStats_Handler,
		},
	},
...
// UnimplementedChatMSServer can be embedded to have forward compatible implementations.
type UnimplementedChatMSServer struct {
}

func (*UnimplementedChatMSServer) CreateRoom(ctx context.Context, req *RoomSettings) (*RoomId, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateRoom not implemented")
}
func (*UnimplementedChatMSServer) DeleteRoom(ctx context.Context, req *RoomId) (*Nothing, error) {
